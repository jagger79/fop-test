...
public class FopController {
    ...
    /**
     * @see https://xmlgraphics.apache.org/fop/2.6/embedding.html
     */
    ...
    void fopTest(HttpServletResponse response,
        ...
        sw.start("get FO xsl");
        InputStream xslFo = getClass().getClassLoader().getResource("xsl-fo/test.fo.xsl").openStream();
        sw.stop();
